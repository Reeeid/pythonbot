...
class LUserSpellSetsCog(commands.Cog):
    ...
    @commands.slash_command(name="lsetspell", description="あなたの呪文セットに呪文を追加します。")
    ...
    @commands.slash_command(name="lunsetspell", description="あなたの呪文セットから呪文を削除します。")
    ...
    @commands.slash_command(name="lresetspellset", description="あなたの呪文セットをリセットします。")
    ...
    @commands.slash_command(name="ldisplayspellset", description="あなたの呪文セットを表示します。")
...
def setup(bot):
    bot.add_cog(LUserSpellSetsCog(bot))
